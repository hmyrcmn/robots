...
class InitializingStateHandler(StateHandler):
    def handle(self, controller: 'MotorController') -> None:
...
class MotorController:
    ...
    def _handle_current_error(self) -> None:
        ...
        set_command(self.ser, "axis0.motor.config.current_lim", 10)  # Akım limitini düşür
    ...
    def _map_odrive_error_to_error_state(self, odrive_error: ODriveError) -> ErrorState:
        ...
        error_mapping = {
            ODriveError.ODRIVE_ERROR_NONE: ErrorState.NO_ERROR,
            ODriveError.ODRIVE_ERROR_INITIALIZING: ErrorState.SYSTEM_ERROR,
            ODriveError.ODRIVE_ERROR_SYSTEM_LEVEL: ErrorState.SYSTEM_ERROR,
            ODriveError.ODRIVE_ERROR_TIMING_ERROR: ErrorState.TIMING_ERROR,
            ODriveError.ODRIVE_ERROR_MISSING_ESTIMATE: ErrorState.ENCODER_ERROR,
            ODriveError.ODRIVE_ERROR_BAD_CONFIG: ErrorState.CONTROLLER_ERROR,
            ODriveError.ODRIVE_ERROR_DRV_FAULT: ErrorState.MOTOR_ERROR,
            ODriveError.ODRIVE_ERROR_MISSING_INPUT: ErrorState.CONTROLLER_ERROR,
            ODriveError.ODRIVE_ERROR_DC_BUS_OVER_VOLTAGE: ErrorState.VOLTAGE_ERROR,
            ODriveError.ODRIVE_ERROR_DC_BUS_UNDER_VOLTAGE: ErrorState.VOLTAGE_ERROR,
            ODriveError.ODRIVE_ERROR_DC_BUS_OVER_CURRENT: ErrorState.CURRENT_ERROR,
            ODriveError.ODRIVE_ERROR_DC_BUS_OVER_REGEN_CURRENT: ErrorState.CURRENT_ERROR,
            ODriveError.ODRIVE_ERROR_CURRENT_LIMIT_VIOLATION: ErrorState.CURRENT_ERROR,
            ODriveError.ODRIVE_ERROR_MOTOR_OVER_TEMP: ErrorState.TEMPERATURE_ERROR,
            ODriveError.ODRIVE_ERROR_INVERTER_OVER_TEMP: ErrorState.TEMPERATURE_ERROR,
            ODriveError.ODRIVE_ERROR_VELOCITY_LIMIT_VIOLATION: ErrorState.SAFETY_ERROR,
            ODriveError.ODRIVE_ERROR_POSITION_LIMIT_VIOLATION: ErrorState.SAFETY_ERROR,
            ODriveError.ODRIVE_ERROR_WATCHDOG_TIMER_EXPIRED: ErrorState.TIMING_ERROR,
            ODriveError.ODRIVE_ERROR_ESTOP_REQUESTED: ErrorState.SAFETY_ERROR,
            ODriveError.ODRIVE_ERROR_SPINOUT_DETECTED: ErrorState.MOTOR_ERROR,
            ODriveError.ODRIVE_ERROR_BRAKE_RESISTOR_DISARMED: ErrorState.SAFETY_ERROR,
            ODriveError.ODRIVE_ERROR_THERMISTOR_DISCONNECTED: ErrorState.TEMPERATURE_ERROR,
            ODriveError.ODRIVE_ERROR_CALIBRATION_ERROR: ErrorState.CALIBRATION_ERROR,
        }

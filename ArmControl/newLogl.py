...
def disable_logging():
    logger.setLevel(logging.CRITICAL,logging.ERROR)
...
def set_logging_level(info_enabled: bool, error_enabled: bool):
    """
    INFO ve ERROR loglarını aç/kapat
    """
    if info_enabled and error_enabled:
        logger.setLevel(logging.INFO)
    elif info_enabled:
        logger.setLevel(logging.INFO)
    elif error_enabled:
...
def enable_info_logs():
    set_logging_level(info_enabled=True, error_enabled=logger.level <= logging.ERROR)

def disable_info_logs():
    set_logging_level(info_enabled=False, error_enabled=logger.level <= logging.ERROR)

def enable_error_logs():
    set_logging_level(info_enabled=logger.level <= logging.INFO, error_enabled=True)

def disable_error_logs():
    set_logging_level(info_enabled=logger.level <= logging.INFO, error_enabled=False)

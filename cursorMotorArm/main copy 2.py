...
class MotorController:
    ...
    def handle_velocity_control_state(self):
        ...
        try:
            ...
            # Tork oku ve temas kontrolü yap
            success = run_command(self.ser, "axis0.motor.foc.Iq_measured", 
                               lambda v: self.check_torque_and_contact(v))
